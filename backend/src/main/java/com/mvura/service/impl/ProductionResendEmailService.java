...
//            log.info("Production Resend email sent to: {}", to);
//        } catch (Exception e) {
//            log.error("Failed to send Resend email to {}: {}", to, e.getMessage(), e);
//        }
//    }
//
//    // Implement the same methods using build templates and calling sendHtmlEmail(...)
